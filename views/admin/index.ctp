...
<h3><?php __('Users');?></h3>
<?php echo $this->requestAction('/users/index/tableonly', array('return')); ?>
<div class="actions">
    <ul>
...
<h3><?php __('Groups');?></h3>
<?php echo $this->requestAction('/groups/index/tableonly', array('return')); ?>
<div class="actions">
    <ul>
...
<h3><?php __('Rules');?></h3>
<?php echo $this->requestAction('/rules/index/tableonly', array('return')); ?>
<div class="actions">
    <ul>
